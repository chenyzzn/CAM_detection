        ...
        if type(img0) == np.ndarray and len(filename)==54:
            ...
            try:
                ...
                if expmessge == "TXT_OK": #日期格式正確
                    ...
                    if datetime.date(y,m,d) > datetime.date(2024, 5, 11): #框選到的是有效日期 
                        ...
                        dfitno.loc[dfitno['外箱條碼']==itemname, '製造/有效'] = 'E'
...
if __name__ == '__main__':
    on_ocr('D:\\R_CAM\\phot\\*')
    opfile = "C:\\AI_exp\\HP\\Partdata\\itfpara_POC.xlsx"
    dfitno.to_excel(opfile, index=False)